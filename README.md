# Pakenham Plumbers &amp; Pergolas — rank-and-rent microsite
...
| Item | Value |
|---|---|
| Domain | `pakenhamplumbers.com.au` (registered, GoDaddy fraud-pending) |
| Live URL (interim) | https://pakenhamplumbers.netlify.app |
...
│   ├── officer.astro         # /lakeside/
│   ├── berwick.astro         # /officer/
│   ├── beaconsfield.astro    # /heritage-springs/
│   ├── cardinia.astro        # /cardinia-shire/ (shire-wide overview)
...
├── whisper.js                # "Pete's Lead from Pakenham Plumbers &amp; Pergolas" played to contractor before patching caller through
...
| `TENANT_BRAND` | `Pakenham Plumbers &amp; Pergolas` (default) | What plays after the label — full whisper is `"Pete's Lead. Pete's Lead from Pakenham Plumbers &amp; Pergolas."` |
...
3. Submit to Google Search Console (`sc-domain:pakenhamplumbers.com.au`).
4. Set up Google Business Profile (needs registered business name "Pakenham Plumbers &amp; Pergolas" first).
...
|---|---|
| Local fit | Pakenham/Lakeside estates are sloped — demand is structural, not weather-cyclical |
